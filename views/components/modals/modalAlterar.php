...
<dialog id="modalAlterar">
    <div class="modal-content">
        ...
        <h2>Alterar <?= $modalEspecifico ?></h2>

        <form action="../../controllers/actions/alterarAction.php" method="POST" enctype="multipart/form-data">
            <div class="parent">
                <?php foreach ($eventos as $evento): ?>
                    <section id="coluna1">
                        <div class="div1">
                            ...
                            <input type="text" id="nome" name="nome" placeholder="<?php echo htmlspecialchars($evento['nome']); ?>" required>
                            
                            <label for="nome">Categoria</label>
                            <select id="categoria" name="categoria" required>
                                <option value=""><?php echo htmlspecialchars($evento['categoria']); ?></option>
                            ...
                            <textarea id="descricao" name="descricao" placeholder="<?php echo htmlspecialchars($evento['descricao']); ?>" required></textarea>
                        ...
                        <div class="div2">
                            ...
                            <div class="input-group">
                                <div class="input-item">
                                    ...
                                    <input type="text" id="cidade" name="cidade" placeholder="<?php echo htmlspecialchars($evento['cidade']); ?>" required>
                                </div>
                                <div class="input-item">
                                    <label for="estado">Estado</label>
                                    <select id="estado" name="estado" required>
                                        <option value=""><?php echo htmlspecialchars($evento['estado']); ?></option>
                            ...
                            <input type="text" id="nome_local" name="nome_local" placeholder="<?php echo htmlspecialchars($evento['nome_local']); ?>" required>
                            
                            <div id="divRua" class="input-group">
                                <div class="input-item">
                                    <label for="rua">Rua</label>
                                    <input type="text" id="rua" name="rua" placeholder="<?php echo htmlspecialchars($evento['rua']); ?>" required>
                                </div>

                                <div class="input-item">
                                    <label for="numRua">Número</label>
                                    <input type="text" id="numRua" name="numRua" placeholder="<?php echo htmlspecialchars($evento['numero']); ?>" required>
                                </div>
                            </div>
                            
                            <label for="bairro">Bairro</label>
                            <input type="text" id="bairro" name="bairro" placeholder="<?php echo htmlspecialchars($evento['bairro']); ?>" required>
                        </div>
                    ...
                    <section id="coluna2">
                        <div class="div4">
                            ...
                            <input type="date" id="data_inicio" name="data_inicio" value="<?php echo htmlspecialchars($evento['data_inicio']); ?>" placeholder="<?php echo htmlspecialchars($evento['data_inicio']); ?>" required>
        
                            <label for="data_fim">Data Final</label>
                            <input type="date" id="data_fim" name="data_fim" value="<?php echo htmlspecialchars($evento['data_fim']); ?>" placeholder="<?php echo htmlspecialchars($evento['data_fim']); ?>" required>
                        </div>
